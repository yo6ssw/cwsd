// source: https://stackoverflow.com/questions/2638654/redirect-c-stdclog-to-syslog-on-unix
#ifndef SYSLOG_HPP
#define SYSLOG_HPP
...
extern syslog_stream logger;

#define LOG(level) (logger << ##level)

#define LOGINFO (logger << log::info)
#define LOGWARN (logger << log::warning)
#define LOGERROR ((logger << log::error))
#define LOGDEBUG (logger << log::debug)
